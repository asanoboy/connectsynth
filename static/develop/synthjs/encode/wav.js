goog.provide("synthjs.encode.Wav");

/**
 * @construct
 */
synthjs.encode.Wav = function(opt_params){
...
synthjs.encode.Wav.prototype.eof = function(){
	return this._eof;
}

synthjs.encode.Wav.prototype.getWavInt16Array = function(buffer){
