...
// Please do not edit.
goog.addDependency('../../synthjs/application/base.js', ['synthjs.application.Base'], ['synthjs.audiocore.Player', 'synthjs.ui.MenuAndBody']);
goog.addDependency('../../synthjs/application/module/oscillator.js', ['synthjs.application.module.Oscillator', 'synthjs.application.module.OscillatorEventType'], ['goog.events.EventTarget', 'synthjs.audiocore.DynamicGenerator', 'synthjs.audiocore.Note', 'synthjs.audiocore.Player', 'synthjs.audiocore.WavePlugin', 'synthjs.audiocore.WavePluginEventType', 'synthjs.model.Collection', 'synthjs.model.PluginControlParam', 'synthjs.model.PluginRadioParam', 'synthjs.model.PluginToggleParam', 'synthjs.ui.Keyboard', 'synthjs.ui.PluginControlPanel', 'synthjs.ui.VerticalKeyboardRenderer', 'synthjs.ui.window.Oscillator', 'synthjs.utility.EventTarget']);
goog.addDependency('../../synthjs/application/oscillatorplayer.js', ['synthjs.application.OscillatorPlayer'], ['goog.Uri', 'goog.dom', 'goog.events.EventHandler', 'goog.ui.Dialog', 'goog.ui.Dialog.ButtonSet', 'goog.ui.Dialog.DefaultButtonKeys', 'synthjs.application.Base', 'synthjs.application.module.Oscillator', 'synthjs.audiocore.DynamicGenerator', 'synthjs.audiocore.Note', 'synthjs.audiocore.WavePlugin', 'synthjs.ui.Keyboard', 'synthjs.ui.KeyboardEventType', 'synthjs.ui.Menu', 'synthjs.ui.MenuBar', 'synthjs.ui.SDKOscillator', 'synthjs.ui.VerticalKeyboardRenderer', 'synthjs.ui.window.Code', 'synthjs.ui.window.Image', 'synthjs.ui.window.Oscillator', 'synthjs.ui.window.WindowHolder', 'synthjs.utility.AjaxDeferred']);
goog.addDependency('../../synthjs/application/oscillatortestplayer.js', ['synthjs.application.OscillatorTestPlayer'], ['goog.Uri', 'synthjs.application.OscillatorPlayer', 'synthjs.ui.AjaxDialog']);
goog.addDependency('../../synthjs/application/publicoscillator.js', ['synthjs.application.PublicOscillator'], ['synthjs.application.SDKOscillatorBase', 'synthjs.ui.DirectoryControl', 'synthjs.utility.AjaxDeferred']);
...
goog.addDependency('../../synthjs/application/sdkoscillatorbase.js', ['synthjs.application.SDKOscillatorBase'], ['synthjs.application.OscillatorPlayer', 'synthjs.model.Collection', 'synthjs.model.FileSystem', 'synthjs.model.TextFile', 'synthjs.ui.AjaxLoader']);
...
goog.addDependency('../../synthjs/encode/blobbuilder.js', ['synthjs.encode.BlobBuilder'], []);
