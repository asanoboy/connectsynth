...
goog.provide('synthjs.utility.DeferredList');
 ...
 */
synthjs.utility.DeferredList = function(list,
                                   opt_fireOnOneCallback,
                                   opt_fireOnOneErrback,
                                   opt_consumeErrors,
                                   opt_canceller,
                                   opt_defaultScope) {
  synthjs.utility.Deferred.call(this, opt_canceller, opt_defaultScope);
...
goog.inherits(synthjs.utility.DeferredList, synthjs.utility.Deferred);
 ...
 * @private
 */
synthjs.utility.DeferredList.prototype.numFinished_ = 0;
 ...
 * @private
 */
synthjs.utility.DeferredList.prototype.handleCallback_ = function(index,
                                                             success,
                                                             result) {
  this.numFinished_++;
...
/** @inheritDoc */
synthjs.utility.DeferredList.prototype.errback = function(res) {
  synthjs.utility.DeferredList.superClass_.errback.call(this, res);
 ...
 */
synthjs.utility.DeferredList.gatherResults = function(list) {
  var d = new synthjs.utility.DeferredList(list, false, true);
